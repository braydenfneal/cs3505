...
//    print_grid  (pdf, page);
    /* text along a circle */
    angle2 = -180;//What angle u want to start at (Start at negative)
    float r = 30;//How far away from the center u want to start
    ...
    for (i = 0; i < strlen (SAMP_TXT); i++) {
        ...
        float x;
        float y;
        r = r-750/angle2;//750 controls how far apart the rows are
        ...
        angle2 -= 850/r; // change the angle around the circle, 850 changes how far apart the letters are
    }
